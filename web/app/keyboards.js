...
// Bloc principal AZERTY (PC). Les variantes 60/75/100 % et Mac ne changent pas
// les lettres : seules les touches périphériques diffèrent (gérées visuellement).
export const ROWS = [
  ...
  [ k('Ctrl','pL',{w:1.4,faded:true,char:null}), k('⌥','pL',{w:1,faded:true,char:null}), k('⌘','pL',{w:1.1,faded:true,char:null}), k('espace','th',{w:6.4,char:' '}), k('AltGr','pR',{w:1.2,faded:true,char:null}), k('Ctrl','pR',{w:1.4,faded:true,char:null}) ]
];

// Map caractère -> touche (pour surligner la prochaine touche).
const CHAR_TO_KEY = {};
